...
$(function(){
    // 一级菜单显示
    new MouseDirection($("#typesOneMenu"), {
        enter: function ($element, dir) {
            $("#typesDetail").parent().css("display","block");
        },
        leave: function ($element, dir) {
            if(dir!="bottom"){
                $("#typesDetail").parent().css("display","none");
            }
        }
    });

    // 一级菜单联动
    new MouseDirection($("#bookTypesMenu").parent(), {
        enter: function ($element, dir) {
    ...
    // 二级菜单联动
    new MouseDirection($("#typesDetail"), {
        enter: function ($element, dir) {
            $element.css("display","block");
        },
        leave: function ($element, dir) {
